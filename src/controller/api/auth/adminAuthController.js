...
exports.login = async (req, res) => {
    ...
    try {
        ...
        if (!isPasswordValid) {
            failUpdate = await db.beresorder.admin.update({
                where: {
                    email
                },
                data: {
            ...
            if (failUpdate.pass_fail < 5) {
                ...
                dataUpdate = await db.beresorder.admin.update({
                    where: {
                        email
                    },
                    data: {
...
exports.sendOtp = async (req, res) => {
    ...
    try {
        ...
        const userUpdate = await db.beresorder.admin.update({
            where: {
                email
            },
            data: {
...
exports.loginWithOtp = async (req, res) => {
    ...
    try {
        ...
        await db.beresorder.admin.update({
            where: {
                id: user.id,
            },
            data: {
